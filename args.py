...
def args_parser():
    ...
    parser.add_argument('--atks', type=int, default=0,
                        help='attack start')
    parser.add_argument('--atke', type=int, default=0,
                        help='attack end')
    
    parser.add_argument('--defense', type=int, default=0,
                        help='server defense or not')
    parser.add_argument('--comment', type=str, default='test', help='logscomment')
